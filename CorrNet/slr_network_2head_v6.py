...
#import modules.resnet_stripped as resnet
#import modules.resnet_convnext as resnet
from modules.resnet_convnext import ConvNeXtSpatial
import os
...
#XY head: ReLU
#Confidence: Sigmoid
#Fixed such that we no longer need the hack which creates the duplicated frames
...
class SLRModel(nn.Module):
    def __init__(
        ...
        #Initialize convnext
        self.conv2d = ConvNeXtSpatial(out_dim=512)
