...
def load_corrnet():
    print("Loading model")
    model_class = import_class('slr_network_sequential_v3_BiLSTM.SLRModel')
    ...
    model = load_model_weights(model, '/data/group1/z40575r/CorrNet_pose_distillation/CorrNet/work_dir/keypoint_regression_seq_v3_BiLSTM/epoch1_step50000.pt')
    #move model to GPU
...
def main():
    ...
    arg_dict = {
        ...
        'output_root': 'keypoints_regression_seq_v3_BiLSTM_50k_ep1',
        'args': args,
    }
