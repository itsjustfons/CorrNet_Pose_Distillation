...
import modules.resnet_timing as resnet
import os
...
class SLRModel(nn.Module):
    ...
    def forward(self, x, len_x=None, label=None, label_lgt=None):
        if len(x.shape) == 5:
            ...
            timings['conv2d'] = time.time() - start
