...
def load_corrnet():
    ...
    model = load_model_weights(model, '/data/group1/z40575r/CorrNet_pose_distillation/CorrNet/work_dir/keypoint_regression_img_grad_accum_v15/epoch0_step140000.pt')
    #move model to GPU 
...
def main():
    ...
    arg_dict = {
        ...
        'output_root': 'keypoints_pose_regression_img_v15_a1_b1_140k',
        'args': args,
    }
