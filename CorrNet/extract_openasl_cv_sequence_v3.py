...
def load_corrnet():
    ...
    model = load_model_weights(model, '/data/group1/z40575r/CorrNet_pose_distillation/CorrNet/work_dir/keypoint_regression_seq_v3/epoch3_step30000.pt')
    #move model to GPU
...
def main():
    ...
    arg_dict = {
        ...
        'output_root': 'keypoints_regression_seq_v3_timing',
        'args': args,
    }
    ...
    '''
    process_single_video("/data/group1/z40575r/GloFE/cropped-vid/1nFdgokPwBw-00-00-14.100-00-00-17.266.mp4", arg_dict, corrnet_model=corrnet_pose)
