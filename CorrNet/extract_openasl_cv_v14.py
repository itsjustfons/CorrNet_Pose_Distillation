...
def load_corrnet():
    ...
    model = load_model_weights(model, '/data/group1/z40575r/CorrNet_pose_distillation/CorrNet/work_dir/keypoint_regression_img_grad_accum_v13_max16_bs8_a1_b1/epoch1_step130000.pt')
    #move model to GPU 
...
def main():
    ...
    arg_dict = {
        ...
        'output_root': 'keypoints_pose_regression_img_v14_a1_b1_timing',
        'args': args,
    }
