...
def load_corrnet():
    print("Loading model")
    model_class = import_class('slr_network_2head_v5.SLRModel') #ensure using correct model slr_network or slr_network2head
    ...
    model = load_model_weights(model, '/data/group1/z40575r/CorrNet_pose_distillation/CorrNet/work_dir/keypoint_regression_img_grad_accum_v16/epoch0_step140000.pt')
    #move model to GPU 
...
def main():
    ...
    arg_dict = {
        ...
        'output_root': 'keypoints_pose_regression_img_v16_a1_b1_140k',
        'args': args,
    }
