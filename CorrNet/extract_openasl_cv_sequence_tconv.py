...
def load_corrnet():
    print("Loading model")
    model_class = import_class('slr_network_sequential_tconv.SLRModel')
    ...
    model = load_model_weights(model, '/data/group1/z40575r/CorrNet_pose_distillation/CorrNet/work_dir/keypoint_regression_seq_tconv/_best_model.pt')
    #move model to GPU
...
def main():
    ...
    arg_dict = {
        ...
        'output_root': 'keypoints_regression_seq_tconv',
        'args': args,
    }
...
def process_single_video(video_path, arg_dict, corrnet_model, max_frames=128):
    #start = time.time()
